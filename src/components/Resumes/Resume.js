      ...
      <section id="resume" className="w-full py-10 border-b-[1px] border-b-black">
        ...
        <div style={{padding:'10px'}}>
          <ol className="text-base font-bodyFont leading-6 tracking-wide">
            ...
            <li>Good Knowledge of State Management with React-Redux /RTK and other React Development Tools eg: HockeyApp,Bitrise & ESLint.</li>
            <li>React Hooks eg: useState,useRef,useEffect etc.</li>
            <li>Working with Graphql, Fetch API and Axios.</li>
            <li>Node + NPM packages.</li>
            <li>Javascript fundamentals eg: Arrays, Functions,Classes, Objects, DOM manipulation & Events Handling.</li>
            <li>Writing Readable codes and Reusable components, Deploying Responsive Web Applications.</li>
            <li>Creating fast and interactive React Applications with latest UI kits eg: Material UI, Ant designs, Chakra UI.</li>
            <li>Good Knowledge of Content Management Systems eg: GraphCMS.</li>
            <li>Excellent communication and Problem-solving/Debugging skills.</li>
